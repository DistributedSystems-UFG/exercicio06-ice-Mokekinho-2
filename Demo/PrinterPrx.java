...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int sub(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_subAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> subAsync(int a, int b)
    {
        return _iceI_subAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> subAsync(int a, int b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_subAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sub", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_a);
                     ostr.writeInt(iceP_b);
                 }, istr -> {
